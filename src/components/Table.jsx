...
return (
    ...
    <div className="relative mb-4 w-full flex justify-between">
        ...
        <div className="flex gap-2">
            <button className="bg-red-200 flex items-center p-2 border rounded-full border-gray-400">Sort By 
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 7.5 7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />
                </svg>
            </button>
            <button className="bg-red-200 items-center p-2 border rounded-full border-gray-400 hidden lg:flex">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
